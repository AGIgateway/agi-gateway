            ...
            <div className="section-spacing container-padding">
                <div className="content-max-width prose-spacing">
                    ...
                    <p className="text-foreground">
                        At AGI Gateway, we value your privacy. We're committed to protecting your personal information and being
                        clear about how we use it. This Privacy Policy explains, in plain language, what information we collect, how
                        we use it, and your rights. It's written with students, parents, and partners in mind – so it's easy to read
                        and transparent.
                    </p>

                    <h2 className="text-foreground">1. Information We Collect</h2>
                    <p className="text-foreground">When you interact with us, we may collect the following details:</p>
                    ...
                    <p className="text-foreground">We use the information you provide to:</p>
                    <ul className="list-disc pl-6 text-foreground">
                    ...
                    <ul className="list-disc pl-6 text-foreground">
                        ...
                        <li>
                            Trusted third-party service providers such as IT, website hosting, or payment processors – always under
                            strict confidentiality.
                        </li>
                    </ul>

                    <h2 className="text-foreground">4. Data Security & Retention</h2>
                    <ul className="list-disc pl-6 text-foreground">
                    ...
                    <p className="text-foreground">
                        Our website uses cookies to improve your experience, analyse performance, and remember your preferences. You
                        can turn off cookies in your browser settings, but some features of our site may not work as expected.
                    </p>

                    <h2 className="text-foreground">7. International Data Transfers</h2>
                    <p className="text-foreground">
                        Because we support students from different parts of the world, your information may be shared with
                        institutions or authorities outside New Zealand. We make sure any such transfers are done securely and only
