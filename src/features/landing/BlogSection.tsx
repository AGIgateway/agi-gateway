      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 lg:mt-12 flex flex-col lg:flex-row gap-6 lg:gap-8 px-0 lg:px-0">
          {memoizedPosts.map((post) => (
            <div
              key={post.id}
              className="flex flex-col items-center w-full max-w-xs lg:max-w-md"
            >
              {/* Blog Image */}
              <img
                src={post.image}
              ...
              {/* Blog Content Card */}
              <div className="flex flex-col gap-3 sm:gap-4 lg:gap-6 items-center bg-global-6 rounded-lg shadow-lg p-4 sm:p-5 lg:p-6 -mt-12 sm:mt-16 lg:-mt-24 mx-4 sm:mx-6 lg:mx-8 w-full max-w-xs lg:max-w-md">
                <h3 className="text-lg sm:text-xl font-semibold leading-7 text-center text-global-4">
                  {post.title}
                </h3>
                <div className="flex gap-2 items-center py-2 lg:py-2">
