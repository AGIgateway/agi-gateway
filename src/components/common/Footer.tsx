        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8 lg:gap-0 py-12 sm:py-16 lg:py-[64px]">
            ...
            <div className="flex flex-col items-start gap-3 sm:gap-4 lg:gap-3 w-full lg:w-[32%]">
              <div className="mt-12 sm:mt-16 lg:mt-[96px] mb-6 sm:mb-8 lg:mb-[123px]">
                <img 
                  src="/images/img_group_2229.svg" 
                  alt="ACI Gateway Logo" 
              ...
              <div className="flex items-center gap-4 mt-4">
                <img 
                  src="/images/img_social_icons.png" 
                  alt="Social media" 
                  className="w-8 h-6"
                />
                <img 
                  src="/images/img_social_icons_white_a700.png" 
                  alt="Social media" 
                  className="w-8 h-6"
                />
                <img 
                  src="/images/img_social_icons_white_a700_24x32.png" 
                  alt="Social media" 
                  className="w-8 h-6"
                />
                <img 
                  src="/images/img_social_icons_24x32.png" 
                  alt="Social media" 
                  className="w-8 h-6"
                />
              </div>
            ...
            <div className="flex flex-col gap-4 sm:gap-6 lg:gap-[24px] w-full lg:w-[8%]">
              ...
              <ul className="flex flex-col gap-3 lg:gap-[12px]">
                <li>
                  <a href="#" className="text-sm text-footer-3 font-normal hover:text-global-7 transition-colors">
                    About us
                  </a>
                </li>
                <li>
                ...
                <div className="flex flex-col gap-4 sm:gap-6 lg:gap-[24px] w-full lg:w-[56%]">
                  ...
                  <div className="flex justify-between items-center bg-global-8 rounded-lg px-3 py-2 lg:px-[12px] lg:py-[8px] w-full">
                    <input
                      ...
                      className="bg-transparent text-sm text-footer-2 placeholder-footer-2 border-none outline-none flex-1"
                    />
                    <img 
